...
function init()
{
	...
	$.post("../ajax/talento.php?op=selectalento", function(r){
	            $("#id_inscripcion").html(r);
	            $('#id_inscripcion').selectpicker('refresh');

	});

	$.post("../ajax/talento.php?op=selectdiss", function(r){
	            $("#id_disciplina").html(r);
	            $('#id_disciplina').selectpicker('refresh');
...
function listar()
{
	...
	"ajax":
	{
		url: '../ajax/talento.php?op=listar',
		type : "get",
		dataType: "json",
		error: function (e)
		{
...
function guardaryeditar(e)
{
	...
	$.ajax(
		{
			url: "../ajax/talento.php?op=guardaryeditar",
			type: "POST",
			data: formData,
			contentType: false,
			processData: false,
