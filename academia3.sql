...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2017 a las 15:03:26
...
CREATE TABLE `competicion` (
  ...
  `nom_competicion` varchar(100) NOT NULL,
  `fec_competicion` date NOT NULL,
  `fecha_fin` date NOT NULL,
  `fec_reg` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ubigeo` int(6) NOT NULL,
...
INSERT INTO `competicion` (`id_competicion`, `nom_competicion`, `fec_competicion`, `fecha_fin`, `fec_reg`, `ubigeo`, `direccion`) VALUES
(1, '100 METROS PLANO', '2017-11-23', '2017-11-30', '2017-11-05 07:23:43', 11, 'ESTADIO NACIONAL'),
(2, 'COMPRAR CORDONES', '2017-11-10', '2017-11-15', '2017-11-05 08:58:14', 221, 'CARRILLO'),
(3, 'PECHO PLAN', '2017-11-24', '2017-12-10', '2017-11-05 09:17:54', 32, 'CHIMBOTE');
...
CREATE TABLE `complejo` (
  ...
  `descripcioncomplejo` varchar(125) NOT NULL,
  `ubigeo` int(6) NOT NULL,
  `direccion` varchar(125) NOT NULL,
  `telefono` int(9) NOT NULL,
  `altitud` decimal(12,6) NOT NULL,
...
INSERT INTO `complejo` (`id_complejo`, `descripcioncomplejo`, `ubigeo`, `direccion`, `telefono`, `altitud`, `longitud`) VALUES
(1, 'Complejo Bien Complejo', 10101, '22 de Octubre 2898', 157862, '-12.000000', '-11.000000'),
(2, 'Complejo Buen Dia', 50401, 'Jr. 04 de Junio Lt 1050', 7896541, '-10.020000', '-22.030000'),
(3, 'UNIVERSO', 23, 'LIMA', 399223, '0.000000', '0.000000');
...
CREATE TABLE `disciplina` (
  `id_coddisciplina` int(11) NOT NULL,
  `ddescripcion` varchar(100) NOT NULL,
  `id_codtipo` int(11) NOT NULL,
...
INSERT INTO `disciplina` (`id_coddisciplina`, `ddescripcion`, `id_codtipo`, `fec_creacion`, `estado`) VALUES
(1, 'Ajedrez', 1, '2017-11-04 23:21:45', 1),
(2, 'Voley', 2, '2017-11-04 23:21:45', 1);
...
INSERT INTO `especialista` (`id_especialista`, `id_persona`, `telefono`, `direccion`, `fec_creacion`) VALUES
(1, 2, 329245, '21 de Abril Zona B', '2017-11-04 23:23:26'),
(2, 3, 879456878, 'Antunes de Mayolo XG5', '2017-11-04 23:24:14');
...
INSERT INTO `horario` (`id_horario`, `id_complejo`, `id_coddisciplina`, `dia`, `hora_inicio`, `hora_fin`, `fec_creacion`) VALUES
(1, 1, 1, 'Lunes', '07:00:00', '13:00:00', '2017-11-04 23:27:33'),
(2, 3, 2, 'Viernes', '12:03:00', '11:23:00', '2017-11-05 09:13:58');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `horario_talento`
--

CREATE TABLE `horario_talento` (
  `id_h_talento` int(11) NOT NULL,
  `id_horario` int(11) NOT NULL,
  `id_complejo` int(11) NOT NULL,
...
CREATE TABLE `inscripcion` (
  ...
  `btalla` decimal(12,2) NOT NULL,
  `bpeso` char(5) NOT NULL,
...
INSERT INTO `inscripcion` (`id_inscripcion`, `id_apoderado`, `telefono`, `direccion`, `id_beneficiario`, `btalla`, `bpeso`, `imagen`, `fec_registro`) VALUES
(1, 3, 7898456, 'Carrillo', 1, '1.71', '72 kg', '', '2017-11-04 23:26:16'),
(2, 2, 3333, '21 de abril', 3, '1.80', '140', '1509858509.jpg', '2017-11-05 05:08:29'),
(3, 3, 943694224, 'huanchaquito', 4, '1.75', '88', '1509873405.jpg', '2017-11-05 09:16:44');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `inscripcion_horario`
--

CREATE TABLE `inscripcion_horario` (
  `id_ins_hor` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `inscripcion_horario`
--

INSERT INTO `inscripcion_horario` (`id_ins_hor`, `id_inscrito`, `id_horario`, `id_especialista`, `fec_reg`) VALUES
(1, 1, 1, 1, '2017-11-04 23:27:46');
...
CREATE TABLE `medallero` (
  `id_medallero` int(11) NOT NULL,
  `id_taleton` int(11) NOT NULL,
  `id_competicion` int(11) NOT NULL,
...
CREATE TABLE `persona` (
  ...
  `vapepaterno` varchar(35) NOT NULL,
  `vapematerno` varchar(35) NOT NULL,
  `vnombres` varchar(75) NOT NULL,
...
INSERT INTO `persona` (`id_persona`, `dnipersona`, `vapepaterno`, `vapematerno`, `vnombres`, `sexo`, `estadocivil`, `fec_nacimiento`, `fec_creacion`, `email`) VALUES
(1, 71065674, 'Becerra', 'Culcos', 'Hristo Airton', 'M', 'S', '1995-08-04', '2017-11-04 16:54:06', 'habc.48@gmail.com'),
(2, 88887875, 'Guerrero', 'Campana', 'Jeanpool', 'M', 'S', '1998-05-05', '2017-11-04 17:04:45', 'habc.48@gmail.com'),
(3, 71065678, 'Armas', 'Hernandez', 'Alejandro', 'M', 'S', '1789-04-05', '2017-11-04 17:09:32', 'jando'),
(4, 71041540, 'sanchez', 'sanchez', 'verlaine', 'M', 'S', '1993-12-24', '2017-11-05 09:15:06', 'stone@hotmail.com');
...
INSERT INTO `talento` (`id_talento`, `id_inscripcion`, `id_disciplina`, `fec_registro`) VALUES
(5, 2, 0, '2017-11-05 09:45:02');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `talento_competicion`
--

CREATE TABLE `talento_competicion` (
  `id_ta_compe` int(11) NOT NULL,
  `id_talento` int(11) NOT NULL,
  `id_competicion` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `talento_inscripcion_horario`
--

CREATE TABLE `talento_inscripcion_horario` (
  `idta_ins_ho` int(11) NOT NULL,
  `id_talento` int(11) NOT NULL,
  `id_horario_talento` int(11) NOT NULL,
  `fec_reg` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `test` (
  ...
  `descripcion_test` varchar(125) NOT NULL,
  `id_inscripcion` int(11) NOT NULL,
  `id_especialista` int(11) NOT NULL,
...
INSERT INTO `test` (`id_test`, `descripcion_test`, `id_inscripcion`, `id_especialista`, `resultado`, `fecha_registro`) VALUES
(4, 'EE', 2, 1, 122, '2017-11-05 06:25:31'),
(5, 'MIRACLE', 1, 2, 130, '2017-11-05 07:00:46'),
(6, 'CORRER 20 KM', 3, 1, 70, '2017-11-05 09:17:20');
...
(5, 'Empleado', 'DNI', '98745632', 'Chiclayo', '98745632', 'empleado@gmail.com', 'empleado', 'empleado', 'cf5a8cdebeb0ee89f3efd6c9a1acb2e3c162b1e7f11b29279dc93b100df9b6c0', '1487132068.jpg', 1),
(10, 'Ana Diaz', 'DNI', '43156952', '', '', '', '', 'ana', '5365669c64d2a2e60a8b90fd71c4c4a8021a3a21d364d7ee40a8015c5b59f9bb', '1487204188.jpg', 1),
(11, 'Luis Arcila Diaz', 'DNI', '74433618', '', '', '', '', 'almacenero', '19b9e4b4b69db1c5c38ea802a1754b4059b4df98cf5213c9c566801b397a952a', '1487450237.png', 1),
(0, 'verlai', 'dni', '71041540', 'huanchaquito', '4848484', 'stone_tlv_13@hotmail.com', 'admin', 'verlain', '7c4a8d09ca3762af61e59520943dc26494f8941b', '1500343507', 1),
(1, 'verlai', 'dni', '71041540', 'huanchaquito', '4848484', 'stone_tlv_13@hotmail.com', 'admin', 'verlain', '7c4a8d09ca3762af61e59520943dc26494f8941b', '1500343507', 1);
...
ALTER TABLE `disciplina`
  ADD PRIMARY KEY (`id_coddisciplina`);
...
--
-- Indices de la tabla `horario_talento`
--
ALTER TABLE `horario_talento`
  ADD PRIMARY KEY (`id_h_talento`);
...
--
-- Indices de la tabla `inscripcion_horario`
--
ALTER TABLE `inscripcion_horario`
  ADD PRIMARY KEY (`id_ins_hor`);

--
-- Indices de la tabla `medallero`
--
ALTER TABLE `medallero`
  ADD PRIMARY KEY (`id_medallero`);
...
--
-- Indices de la tabla `talento_competicion`
--
ALTER TABLE `talento_competicion`
  ADD PRIMARY KEY (`id_ta_compe`);

--
-- Indices de la tabla `talento_inscripcion_horario`
--
ALTER TABLE `talento_inscripcion_horario`
  ADD PRIMARY KEY (`idta_ins_ho`);
...
--
ALTER TABLE `disciplina`
  MODIFY `id_coddisciplina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT de la tabla `horario_talento`
--
ALTER TABLE `horario_talento`
  MODIFY `id_h_talento` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `inscripcion_horario`
--
ALTER TABLE `inscripcion_horario`
  MODIFY `id_ins_hor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `medallero`
--
ALTER TABLE `medallero`
  MODIFY `id_medallero` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `talento`
  MODIFY `id_talento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `talento_competicion`
--
ALTER TABLE `talento_competicion`
  MODIFY `id_ta_compe` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `talento_inscripcion_horario`
--
ALTER TABLE `talento_inscripcion_horario`
  MODIFY `idta_ins_ho` int(11) NOT NULL AUTO_INCREMENT;
--
